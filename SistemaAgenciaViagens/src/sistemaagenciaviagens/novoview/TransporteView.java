...
public class TransporteView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        veiculoOption = new javax.swing.JComboBox<>();
        ...
        cadastrarButton.setText("Cadastrar Novo Transportes");
        ...
        alterarButton.setText("Alterar Transportes");
        ...
        listarButton.setText("Listar Todos os Transportes");
        ...
        excluirButton.setText("Excluir Transporte");
        ...
        EmpresaLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        EmpresaLabel.setText("*Empresa: ");

        VeiculoLabel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
                ...
                .addGroup(dadosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dadosPanelLayout.createSequentialGroup()
                        .addGroup(dadosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(EmpresaLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(VeiculoLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(dadosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(veiculoOption, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        dadosPanelLayout.setVerticalGroup(
            ...
            .addGroup(dadosPanelLayout.createSequentialGroup()
                ...
                .addGroup(dadosPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(veiculoOption, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(51, 51, 51)
    ...
    private void salvarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarButtonActionPerformed
        ...
        String veiculo = veiculoOption.getItemAt(veiculoOption.getSelectedIndex());
        
        
        if(!((nomeEmpresa.equals("")) || (veiculo.equals(""))))
        {
            try {
                this.controlador.salvar(codigo, nomeEmpresa, veiculo);
                JOptionPane.showMessageDialog(rootPane, "Transporte Salvo com sucesso!");
                dadosPanel.setVisible(false);
                limparDados();
                atualizarTabela();
            } catch (Exception ex) {
    ...
    private void alterarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarButtonActionPerformed
        ...
        if(selectedRow > -1)
        {
            ...
            empresaField.setText(modelo.getValueAt(selectedRow, 1).toString());        
        ...
        {
            JOptionPane.showMessageDialog(rootPane, "Selecione um transporte para alterar!");
        }
    ...
    private void excluirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirButtonActionPerformed
        ...
        if(selectedRow > -1)
        {
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "Transporte excluido com sucesso!");
                atualizarTabela();
            } catch (Exception e) {
        ...
        {   
            JOptionPane.showMessageDialog(rootPane, "Selecione um transporte para excluir!");
        }
    ...
    private void limparDados(){
        ...
        veiculoOption.setSelectedIndex(0);
    }
    ...
    private void atualizarTabela(){
        ...
        for(int i=0; i<this.controlador.getListaTransporte().size(); i++){
            ...
            ((DefaultTableModel) dadosTable.getModel()).addRow(new Object[]{
                this.controlador.getListaTransporte().get(i).getCodigo(),
                this.controlador.getListaTransporte().get(i).getNomeEmpresa(),
                this.controlador.getListaTransporte().get(i).getVeiculo(),
    ...
    private javax.swing.JComboBox<String> veiculoOption;
